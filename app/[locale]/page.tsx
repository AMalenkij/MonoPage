		...
		<LenisProvider>
			...
			<div className="flex flex-col lg:flex-row lg:items-end sm:h-[1100px] h-[900px] container mx-auto">
				<section className="w-full lg:w-1/2 lg:h-2/3 flex-row  mt-12 sm:mt-10">
					<TextEffect
						className="text-2xl sm:text-4xl md:text-4xl lg:text-6xl font-semibold mb-4 sm:mb-7 lg:mb-10"
						as="h1"
						preset="fade"
					>
						{tHero("title")}
					...
					<TextEffect
						className="pl-1 text-lg font-light sm:text-2xl md:text-lg lg:text-lg mb-6 lg:mb-14"
						per="word"
						as="p"
						preset="blur"
					>
					...
					<Dialog>
						<DialogTrigger asChild>
							...
							<button
								type="button"
								className="no-underline disabled:cursor-not-allowed bg-white text-black active:bg-grey-300 border-transparent rounded-full group/arrow group/button inline-flex items-center overflow-hidden border text-base font-medium transition"
							>
								<span className="pl-6 pr-16 py-3 relative inline-flex items-center">
									...
									<div className="relative flex items-center justify-end inset-x-6">
										<div className="group-hover/arrow:before:translate-x-0 absolute left-0 right-[2px] flex h-[1.5px] origin-right justify-end overflow-hidden rounded-full before:w-full before:translate-x-[calc(100%-16px)] before:rounded-full before:bg-current before:transition-transform" />
